class Endpoints {
  ...
  static const String getPaymentMethods =
      ...
      static String getPaymentSettings(String paymentTypeId) => "$baseUrl1/customer/payment-settings-per-type?paymentTypeId=$paymentTypeId&countryCode=CM&transactionType=buy";
}
